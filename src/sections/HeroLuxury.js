...
const HeroLuxury = () => {
  ...
  const dummyCars = [
    ...
    },
    {
      ...
      name: 'BMW 5 Series',
      seats: 4,
      image: 'https://cdn.pixabay.com/photo/2012/05/29/00/43/bmw-49278_1280.jpg',
      price: '£50',
    },
    {
      id: 3,
              ...
              {dummyCars.map(car => (
                <div className="col-md-4 mb-4" key={car.id}>
                  <div className="card shadow h-100 border-0">
                    <img src={car.image} alt={car.name} className="card-img-top" style={{height: '180px', objectFit: 'cover', borderTopLeftRadius: '1rem', borderTopRightRadius: '1rem'}} />
                    <div className="card-body">
                      <h5 className="card-title">{car.name}</h5>
                      <p className="card-text mb-1"><strong>Seats:</strong> {car.seats}</p>
                      <p className="card-text mb-2"><strong>Price:</strong> {car.price}</p>
                      <button
                        className="btn btn-primary w-100"
                        onClick={() => navigate('/booking', { state: { car, form } })}
                      >
                        Book Now
                      </button>
                    </div>
