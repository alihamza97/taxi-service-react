...
const NewsletterSection = () => (
  <section id="newsletter" className="newsletter-section py-5 bg-primary text-white">
    <div className="container">
      <h2 className="text-center mb-4">Newsletter</h2>
      <form onSubmit={e => { e.preventDefault(); alert('Subscribed! (Demo only)'); }} className="row justify-content-center">
